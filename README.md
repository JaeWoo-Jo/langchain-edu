...
"안녕!"의 GEval이 0.26→0.81로 오른 것은 에이전트가 나아진 것이 아니라, 인사에 "가격 정보 포함 여부"를 묻던 부당한 채점 기준을 분리한 결과입니다. 또한 "쌀이랑 콩 가격 비교해줘"는 4주차에서도 Task Completion 0.6으로 여전히 실패하며, 복수 품목 동시 조회는 남은 과제입니다.
...
└──────────────┘  ← SSE   │  ┌────────────────────────────────────────┐    │
                           ...
                           │                                               │
                           │  ┌───────────┐ ┌──────────────┐ ┌─────────┐  │
                           │  │ search    │ │ compare      │ │ create  │  │
                           │  │ _price    │ │ _prices      │ │ _price  │  │
                           │  │           │ │              │ │ _chart  │  │
                           │  └─────┬─────┘ └──────┬───────┘ └────┬────┘  │
                           │        │              │              │       │
                           │        ▼              ▼              ▼       │
